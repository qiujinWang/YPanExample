...
// HMACSigner
#define COCOAPODS_POD_AVAILABLE_HMACSigner
#define COCOAPODS_VERSION_MAJOR_HMACSigner 0
#define COCOAPODS_VERSION_MINOR_HMACSigner 1
#define COCOAPODS_VERSION_PATCH_HMACSigner 0
